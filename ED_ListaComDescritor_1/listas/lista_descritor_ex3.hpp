...
{
    /// cout << n
    return os << n->dado.placa << "#" << n->dado.ano << "#" << n->dado.fabricante << "#" << n->dado.modelo;
}
...
template<typename T>
bool removeFabricanteAnoL(Lista<T> *lista, T valor)
{
    No <T>*anterior = nullptr;
    No <T>*atual = lista->inicio;
    ///fica no laço enquanto tiver elementos na lista
    ...
    while(atual && atual->dado.fabricante != valor.fabricante)
    {
        anterior = atual;
        atual = atual->prox;

        while(atual && atual->dado.fabricante == valor.fabricante && atual->dado.ano <= 2000)
        {
            anterior = atual;
            atual = atual->prox;
        }
...
template<typename T>
bool removePlacaL(Lista<T> *lista, T valor)
{
    No <T>*anterior = nullptr;
    No <T>*atual = lista->inicio;
    ///fica no laço enquanto tiver elementos na lista
...
template<typename T>
bool buscaFabricanteL(Lista<T> *lista, T valor) ///
{
    ...
    while (n)
    {
        if (n->dado.fabricante == valor.fabricante)
        {
